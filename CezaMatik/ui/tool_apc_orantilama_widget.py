...
class APCProportionToolWidget(QWidget):
    ...
    def setupUI(self):
        ...
        intro_label = QLabel(
            ...
            "doğrusal orantı kurar. Tüm hapis süreleri önce güne çevrilir."
        )
        ...
        calculate_btn.clicked.connect(self.calculateProportion)
        ...
        result_layout.addWidget(self.proportional_result_label)
        result_layout.addWidget(self.rounded_result_label)
    ...
    def createAPCGroup(self):
        ...
        self.apc_alt_input.setMinimumWidth(86)
        self.apc_alt_input.setMaximumWidth(110)
        self.apc_ust_input.setMinimumWidth(86)
        self.apc_ust_input.setMaximumWidth(110)
