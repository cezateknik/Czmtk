...
class AgeCalculationToolWidget(QWidget):
    ...
    def setupUI(self):
        ...
        layout.addWidget(self.createResultRow(self.crime_age_label))
        layout.addWidget(self.createResultRow(self.current_age_label))
        layout.addWidget(self.createResultRow(self.hearing_type_label))
    ...
    def resetTool(self):
        today = QDate.currentDate()
        self.birth_date_input.setDate(today.addYears(-18))
        self.crime_date_input.setDate(today)
        self.current_date_input.setDate(today)
        self.error_label.clear()
        self.crime_age_label.setText("Suç Tarihindeki Yaşı: 0 yıl, 0 ay, 0 gün")
        self.current_age_label.setText("Şimdiki Yaşı: 0 yıl, 0 ay, 0 gün")
        self.hearing_type_label.setText("Duruşma Türü: DURUŞMA KAPALI")
