...
class SentenceDaysToolWidget(QWidget):
    ...
    def createSentenceToDaysTab(self):
        ...
        layout.addWidget(self.createResultRow(self.sentence_to_days_result))
        layout.addWidget(self.createResultRow(self.fine_amount_result))
        layout.addStretch()
        return tab
    ...
    def createFineGroup(self):
        ...
        for idx, button in enumerate((self.fine_radio_20, self.fine_radio_100, self.fine_radio_500)):
            ...
            button.toggled.connect(self.handlePresetFineSelected)
    ...
    def createDaysToSentenceTab(self):
        ...
        self.total_days_input.setMinimumWidth(48)
        self.total_days_input.setMaximumWidth(58)
        label = QLabel("Gün:")
        ...
        copy_btn = self.createCopyButton(self.days_to_sentence_result)
        ...
        group_layout.addWidget(copy_btn, 0, 5)
        group_layout.setColumnStretch(6, 1)
    ...
    def handlePresetFineSelected(self, checked):
        if checked and self.custom_fine_input.text().strip():
            self.custom_fine_input.clear()
    ...
    def resetTool(self):
        self.sentence_year_input.clear()
        self.sentence_month_input.clear()
        self.sentence_day_input.clear()
        self.total_days_input.clear()
        self.custom_fine_input.clear()
        self.fine_radio_20.setChecked(True)
        self.sentence_to_days_result.setText("Toplam: 0 gün")
        self.fine_amount_result.setText("Adli Para Cezası Tutarı: 0 TL")
        self.days_to_sentence_result.setText("0 gün")
