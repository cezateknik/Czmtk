...
<p>CezaMat'ik, İshak KOCATEPE tarafından yapay zeka desteğiyle Python ve Qt tabanlı olarak geliştirilmiş bir masaüstü uygulamasıdır. 
...
Kesin ve bağlayıcı sonuçlar garanti edilmez. Uygulama manuel hesaplamayı doğrulamak amacıyla tasarlanmıştır. Asli hesaplayıcı olarak kullanılamaz. Kullanıcı çıkan hesaplamaların doğruluğunu mutlaka kontrol etmelidir. Hesaplama hatalarından doğacak tüm sorumluluk kullanıcıya aittir. (Beta sürümüdür, hesaplama hataları içerebilir!)</p>

<p> <b>Sürüm İyileştirmeleri:</b></p>
<ul>
<li>Dolandırıcılık modülü ondalık sisteme göre güncellendi.</li>
<li>Tam sayı artırımlarındaki hata giderildi. (Örn: 1 kat, 2 kat artırımlar)</li>
<li>30-40 ay gibi yüksek aylardaki hesaplama hataları giderildi.</li>
<li>Güncelleme sekmesi eklendi. Buradan en güncel sürüm kontrolü yapılabilir hale geldi.</li>
<li>Sadece Adli para cezası hesaplamalarındaki "Güncel Ceza" yazım şekli değiştirildi.</li>
...
"""
        ...
        # Version info
        version_label = QLabel("Sürüm: 1.3.3")
